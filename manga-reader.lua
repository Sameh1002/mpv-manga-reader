...
function set_keys()
	if opts.manga then
		mp.add_key_binding("LEFT", "next-page", next_page)
		mp.add_key_binding("RIGHT", "prev-page", prev_page)
		mp.add_key_binding("Shift+LEFT", "next-single-page", next_single_page)
		mp.add_key_binding("Shift+RIGHT", "prev-single-page", prev_single_page)
		mp.add_key_binding("Ctrl+LEFT", "skip-forward", skip_forward)
		mp.add_key_binding("Ctrl+RIGHT", "skip-backward", skip_backward)
	else
		mp.add_key_binding("RIGHT", "next-page", next_page)
		mp.add_key_binding("LEFT", "prev-page", prev_page)
		mp.add_key_binding("Shift+RIGHT", "next-single-page", next_single_page)
		mp.add_key_binding("Shift+LEFT", "prev-single-page", prev_single_page)
		mp.add_key_binding("Ctrl+RIGHT", "skip-forward", skip_forward)
		mp.add_key_binding("Ctrl+LEFT", "skip-backward", skip_backward)
	end
	mp.add_key_binding("UP", "pan-up", pan_up, "repeatable")
	mp.add_key_binding("DOWN", "pan-down", pan_down, "repeatable")
	mp.add_key_binding("HOME", "first-page", first_page)
	mp.add_key_binding("END", "last-page", last_page)
	mp.add_key_binding("MBTN_FORWARD", "next-page-mouse", next_page)
	mp.add_key_binding("MBTN_BACK", "prev-page-mouse", prev_page)
	mp.add_key_binding("/", "jump-page", jump_page)
	mp.add_key_binding("Ctrl+n", "create-bookmark", create_bookmark)
	mp.add_key_binding("Ctrl+u", "update-bookmark", update_bookmark)
end
